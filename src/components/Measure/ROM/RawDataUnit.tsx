      ...
      <div>
        <div className="flex flex-col border-b-2 border-sub200 dark:bodrer bg-sub100 dark:bg-muted">
          ...
          <div className="flex justify-between p-2">
            ...
            <div 
              className="text-sm text-mainBlue-600 px-2 py-1 rounded-full border-2 border-mainBlue-600 bg-mainBlue-600-background cursor-pointer hover:border-mainBlue-600/80 transition-colors" 
