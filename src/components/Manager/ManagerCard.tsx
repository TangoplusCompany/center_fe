...
export const ManagerCard = React.memo(({ manager }: ManagerCardProps) => {
  ...
  return (
    <div
      key={manager.sn}
      className="col-span-1 items-center justify-between rounded-xl border-2 border-mainBlue-100 dark:border-mainBlue-600 relative transition-colors overflow-hidden"
    >
      <div className="flex flex-col">
        <div className="flex items-center justify-between rounded-t-xl text-xl text-mainBlue-600 dark:text-white font-semibold bg-mainBlue-100  dark:bg-mainBlue-900 px-4 py-2 w-full">
          {manager.admin_name}
