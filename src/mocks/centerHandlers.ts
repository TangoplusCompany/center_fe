...
export const centerHandlers = [
  http.get("http://localhost:4862/api/center", async () => {
    ...
    return new HttpResponse(JSON.stringify(chartData), { status: 200 });
  }),
  http.get("http://localhost:4862/api/center/use", async () => {
    const chartData = [
