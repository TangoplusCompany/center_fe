            ...
            .forEach((frame, index) => {
              if (index === 0) {
                return contextLeftBlue.moveTo(
                  frame.pose_landmark[25].sx * scaleWidth,
                  frame.pose_landmark[25].sy * scaleHeight,
                );
              }
            ...
            .forEach((frame, index) => {
              if (index === 0) {
                contextRightBlue.moveTo(
                  frame.pose_landmark[26].sx * scaleWidth,
                  frame.pose_landmark[26].sy * scaleHeight,
                );
              }
