export interface IBiaData extends IBiaInfo, IBiaComposition, IBiaMainAnalysis, IBiaBodyPart, IBiaRecommend, IBiaBodyBenchmark, IBiaMostPreviousData, IBiaHistoryDatas {}
