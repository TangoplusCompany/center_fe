  ...
  return (
    <div 
      ...
      className={[
        ...
        regDate 
          ? "border-sub300/50 dark:border-border dark:bg-card cursor-pointer hover:border-toggleAccent hover:bg-toggleAccent-background dark:hover:bg-toggleAccent-background active:bg-toggleAccent-background active:border-toggleAccent" // 데이터 있을 때
