        ...
        <div className="flex flex-col lg:flex-row w-full gap-2 sm:gap-3 md:gap-4">
          ...
          <div className="w-full lg:flex-1 min-w-0">
            <div className="flex flex-col h-full w-full rounded-3xl border-2 border-sub200 bg-white relative overflow-hidden">
              ...
              <div className="absolute bottom-0 right-0 w-48 h-full bg-gray-200" />
            </div>
          </div>
          {/* Best 카드 */}
          <div className="w-full lg:flex-1 min-w-0">
        ...
        <div className="w-full min-w-0">
          <div className="flex flex-col gap-6">
            ...
            <div className="rounded-3xl border-2 border-sub200 p-3 sm:p-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4">
                <div className="flex flex-col gap-4">
                  <h3 className="text-xl font-semibold">상지 결과</h3>
            ...
            <div className="rounded-3xl border-2 border-sub200 p-3 sm:p-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4">
                <div className="flex flex-col gap-4">
                  <h3 className="text-xl font-semibold">하지 결과</h3>
                  <Skeleton className="h-32 w-full rounded-lg" />
                </div>
                <Skeleton className="h-32 w-full rounded-lg" />
              </div>
            ...
            {/* 정적 족압 결과 */}
            <div className="flex flex-col h-full gap-6 sm:gap-8 rounded-3xl border-2 border-sub200 p-3 sm:p-4">
              <h3 className="text-xl font-semibold">정적 족압 결과</h3>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4">
