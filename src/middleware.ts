...
export const config = {
  matcher: [
    ...
    "/result-page/:path*",
    // ✅ 기존 matcher 유지
    "/((?!login|find|unlock|result-sheet|result-page|api|register|subRegister|delegation|_next|favicon.ico|.*\\.(?:png|jpg|jpeg|svg|gif|webp|ico|woff|woff2|ttf|gltf|glb|bin)$).*)",
  ],
};
