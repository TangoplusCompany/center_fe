  ...
  return (
    ...
    >
      <div className="w-full flex flex-col">
        <div className="flex items-center justify-start rounded-t-xl text-xl text-toggleAccent dark:text-white font-semibold bg-toggleAccent-background px-4 py-2 w-full">
          {device.device_name}
        </div>
