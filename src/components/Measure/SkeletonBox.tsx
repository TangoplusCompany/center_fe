...
const SkeletonBox = ({ data }: { data: IUserDetailMeasureInfo }) => {
  ...
  return (
    <div className="relative box-border flex justify-center rounded-[20px] border border-stroke bg-gray p-6 text-black  focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary">
