...
export default function AnnouncementDetail({
  ...
  return (
    <div className="flex flex-col gap-4 p-2">
      ...
      <button
        type="button"
        onClick={handleBack} // () => setAnnouncementSn(undefined) 대신 handleBack 연결
        className="flex items-center gap-2 text-sm text-gray-600 hover:text-gray-900 transition-colors w-fit cursor-pointer"
      >
        <svg
      ...
      <div className="flex flex-col gap-2 w-full min-h-[600px]">
        <div className="flex flex-col grow justify-between gap-6">
          ...
          <div className="grow space-y-6">
            <div className="flex flex-col text-sub800 gap-2 border-b pb-4">
            ...
            {/* 본문 */}
            <div className="md:text-base text-sm whitespace-pre-wrap leading-relaxed text-gray-800">
          ...
          {announcement.attachments && announcement.attachments.length > 0 && (
            <div className="flex flex-col bg-sub100/50 border rounded-lg p-4 gap-2 mt-auto">
