  ...
  return (
    <div className="flex-1 p-4">
      ...
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-xl font-semibold text-sub800 dark:text-sub100">무릎 이동</h3>
      </div>

      <div className="flex justify-center gap-4">
        <div className="flex justify-center mb-4">
          <div className="flex flex-col items-center w-fit">
            <div className="w-full rounded-md border dark:border-border text-center py-1 mb-1 text-sub800 dark:text-sub100">
              무릎이동 궤적(L)
            </div>
